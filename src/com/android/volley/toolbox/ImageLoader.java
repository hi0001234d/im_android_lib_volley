...
//                	Log.v("lazy", "response");
     ...
     */
    public ImageContainer getLazy(String requestUrl, ImageListener imageListener, int maxWidth, int maxHeight, final ProgressBar pb ) 
    {
        // only fulfill requests that were initiated from the main thread.
        throwIfNotOnMainThread();
...
//                	Log.v("lazy", "response");
                	...
                	//hide lazy loader
                	pb.setVisibility(View.GONE);
                	//Log.v("lazy", "loader hide success" );
